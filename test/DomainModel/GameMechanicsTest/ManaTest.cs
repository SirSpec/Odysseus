...
namespace Odysseus.DomainModel.GameMechanicsTest
{
    public class ManaTest
    {
        ...
        {
            //Arrange
            var sut = new Mana(new Level(1), new CharacterAttribute(1));
        ...
        {
            //Arrange
            var sut = new Mana(new Level(100), new CharacterAttribute(1));
        ...
        {
            //Arrange
            var sut = new Mana(new Level(100), new CharacterAttribute(100));
