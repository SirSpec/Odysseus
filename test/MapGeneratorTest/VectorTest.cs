...
namespace Theseus.MapGeneratorTest
{
    public class VectorTest
    {
        ...
        {
            //Arrange
            var testObject = new Vector();

            //Act
            var (start, end) = testObject;
        ...
        {
            //Arrange
            var testObject = new Vector(new Tile(1, 2), new Tile(3, 4));
        ...
        {
            //Arrange
            var testObject1 = new Vector();
            var testObject2 = new Vector();
        ...
        {
            //Arrange
            var testObject1 = new Vector(new Tile(1, 2), new Tile(3, 4));
            var testObject2 = new Vector(new Tile(1, 2), new Tile(3, 4));
        ...
        public void Equals_DifferentParameters_False()
        {
            //Arrange
            var testObject1 = new Vector(new Tile(1, 2), new Tile(3, 4));
            var testObject2 = new Vector(new Tile(1, 2), new Tile(3, 5));

            var testObject3 = new Vector(new Tile(5, 2), new Tile(3, 4));
            var testObject4 = new Vector(new Tile(6, 2), new Tile(3, 4));
